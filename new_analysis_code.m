...
for m=1:length(subject_id)
    ...
    for k=1:length(d_data)
        ...
        data_out_all=extract_condition_response(data,info,'S','probe',true,false);
        ...
        data_out_all=extract_condition_response(data,info,'W','probe',true,false);
        ...
        data_out_all=extract_condition_response(data,info,'J','probe',true,false);
        ...
        data_out_all=extract_condition_response(data,info,'N','probe',true,false);
...
%     for i=1:5
%         sent_word_freq_tensors_all{i,1}=sent_word_freq_tensors_all{i,1}.*repmat(info.significant_and_positive_channels{i,1},1,8);
%         wlist_word_freq_tensors_all{i,1}=wlist_word_freq_tensors_all{i,1}.*repmat(info.significant_and_positive_channels{i,1},1,8);
%         jab_word_freq_tensors_all{i,1}=jab_word_freq_tensors_all{i,1}.*repmat(info.significant_and_positive_channels{i,1},1,8);
%         non_word_freq_tensors_all{i,1}=non_word_freq_tensors_all{i,1}.*repmat(info.significant_and_positive_channels{i,1},1,8);
%     
%         sent_probe_freq_tensors_all{i,1}=sent_probe_freq_tensors_all{i,1}.*info.significant_and_positive_channels{i,1};
%         wlist_probe_freq_tensors_all{i,1}=wlist_probe_freq_tensors_all{i,1}.*info.significant_and_positive_channels{i,1};
%         jab_probe_freq_tensors_all{i,1}=jab_probe_freq_tensors_all{i,1}.*info.significant_and_positive_channels{i,1};
%         non_probe_freq_tensors_all{i,1}=non_probe_freq_tensors_all{i,1}.*info.significant_and_positive_channels{i,1};
%     end
